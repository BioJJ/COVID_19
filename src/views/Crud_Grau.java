...
public class Crud_Grau extends javax.swing.JFrame {
    ...
    public Crud_Grau() {
        ...
        initComponents();
        DefaultTableModel modelo = (DefaultTableModel) tabela_tipo.getModel();
        tabela_tipo.setRowSorter(new TableRowSorter(modelo));
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Preencha os campos do Grau de Risco");
        ...
        tabela_tipo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabela_tipoMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tabela_tipo);

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(60, 410, 540, 230);
        ...
        txtpesquisar.setBounds(180, 350, 330, 40);
        ...
        btCadastrar.setBounds(540, 260, 50, 50);
        ...
        btExcluir.setBounds(180, 260, 50, 50);
        ...
        btAlterar.setBounds(240, 260, 50, 50);
        ...
        btPesquisar.setBounds(540, 350, 50, 40);
    ...
    public void salvar() {
        if (descricao.getText().equals("")) {
            ...
            grau.setDescricao(descricao.getText());
    ...
    public void excluir() {
        if (tabela_tipo.getSelectedRow() != -1) {
            ...
            grau.setId((int) tabela_tipo.getValueAt(tabela_tipo.getSelectedRow(), 0));
            grauDao.delete(grau);
            readJTable();
            id.setText("");
            descricao.setText("");
    ...
    private void btAlterarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btAlterarMouseClicked
        if (tabela_tipo.getSelectedRow() != -1) {
            descricao.setText(tabela_tipo.getValueAt(tabela_tipo.getSelectedRow(), 1).toString());
        } else {
    ...
    public void alterar() {
        if (descricao.getText().equals("")) {
            ...
            id.setEnabled(false);
        } else if (tabela_tipo.getSelectedRow() != -1) {
    ...
    private void tabela_tipoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabela_tipoMouseClicked
        if (tabela_tipo.getSelectedRow() != -1) {
            id.setText(tabela_tipo.getValueAt(tabela_tipo.getSelectedRow(), 0).toString());
            descricao.setText(tabela_tipo.getValueAt(tabela_tipo.getSelectedRow(), 1).toString());
        }
    }//GEN-LAST:event_tabela_tipoMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Crud_Grau.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

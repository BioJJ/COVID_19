...
public class Crud_Estado extends javax.swing.JFrame {
    ...
    public Crud_Estado() {
        ...
        initComponents();
        DefaultTableModel modelo = (DefaultTableModel) tabela_estado.getModel();
        tabela_estado.setRowSorter(new TableRowSorter(modelo));
    ...
    private void initComponents() {
        ...
        tabela_estado = new javax.swing.JTable();
        ...
        jLabel4.setText("Preencha os campos do Estado");
        ...
        tabela_estado.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tabela_estado.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabela_estadoMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tabela_estado);
    ...
    public void excluir() {
        if (tabela_estado.getSelectedRow() != -1) {
            Estado e = new Estado();
            EstadoDao edao = new EstadoDao();
            e.setId((int) tabela_estado.getValueAt(tabela_estado.getSelectedRow(), 0));
            edao.delete(e);
            readJTable();
            id.setText("");
            descricao.setText("");
    ...
    private void btAlterarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btAlterarMouseClicked
        if (tabela_estado.getSelectedRow() != -1) {
            descricao.setText(tabela_estado.getValueAt(tabela_estado.getSelectedRow(), 1).toString());
        } else {
    ...
    public void alterar() {
        if (descricao.getText().equals("")) {
            ...
            id.setEnabled(false);
        } else if (tabela_estado.getSelectedRow() != -1) {
            Estado e = new Estado();
            EstadoDao edao = new EstadoDao();
    ...
    private void tabela_estadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabela_estadoMouseClicked
        if (tabela_estado.getSelectedRow() != -1) {
            id.setText(tabela_estado.getValueAt(tabela_estado.getSelectedRow(), 0).toString());
            descricao.setText(tabela_estado.getValueAt(tabela_estado.getSelectedRow(), 1).toString());
        }
    }//GEN-LAST:event_tabela_estadoMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Crud_Estado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tabela_estado;
